...
DISCLAIMER POST VIDEO: en el video nombro que esta bien acceder a la carga de las apuestas con load bets sin lock ya que todos los procesos van a estar leyendo para ese momento, ninguno escribiendo. Lo que afirme es claramente ERRONEO, esta especificado encima del codigo de load bets con un comentario que indica que el acceso NO ES PROCESS SAFE.
Corrijo en este commit tomando un lock a la hora de cargar las apuestas, y que de esta manera sea process safe.
